...
const About = () => {
    ...
    return (
        <motion.div
            ...
            <motion.h1 variants={h1Variants}>about</motion.h1>
            ...
            <p>In Jan 2025, I set myself the challenge of creating an MVP in just 2-3 weeks—a timeframe that mimics a sprint. It was a journey of learning, from gathering requirements to building a web app without a step-by-step guide. Through research, peer advice, search through numerous wesites for ideas and after lots of trial and error, I’m thrilled with the outcome!</p> 
